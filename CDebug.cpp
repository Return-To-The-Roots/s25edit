...
CDebug::CDebug(void dbgCallback(int), int quitParam)
{
    ...
    dbgWnd->addText("Debugger started", Point16(0, 0), fontsize);
    ...
    dbgWnd->addButton(dbgCallback, DECREMENT_MSWAIT, Point16(75, 30), Extent16(15, 15), BUTTON_GREY, "-");
    dbgWnd->addButton(dbgCallback, SETZERO_MSWAIT, Point16(90, 30), Extent16(15, 15), BUTTON_GREY, "0");
    dbgWnd->addButton(dbgCallback, INCREMENT_MSWAIT, Point16(105, 30), Extent16(15, 15), BUTTON_GREY, "+");

    // we draw a vertical line to separate map data on the right side from things on the left side
    dbgWnd->addText("#", Point16(240, 10), fontsize);
    dbgWnd->addText("#", Point16(240, 20), fontsize);
    dbgWnd->addText("#", Point16(240, 30), fontsize);
    dbgWnd->addText("#", Point16(240, 40), fontsize);
    dbgWnd->addText("#", Point16(240, 50), fontsize);
    dbgWnd->addText("#", Point16(240, 60), fontsize);
    dbgWnd->addText("#", Point16(240, 70), fontsize);
    dbgWnd->addText("#", Point16(240, 80), fontsize);
    dbgWnd->addText("#", Point16(240, 90), fontsize);
    dbgWnd->addText("#", Point16(240, 100), fontsize);
    dbgWnd->addText("#", Point16(240, 110), fontsize);
    dbgWnd->addText("#", Point16(240, 120), fontsize);
    dbgWnd->addText("#", Point16(240, 130), fontsize);
    dbgWnd->addText("#", Point16(240, 140), fontsize);
    dbgWnd->addText("#", Point16(240, 150), fontsize);
    dbgWnd->addText("#", Point16(240, 160), fontsize);
    dbgWnd->addText("#", Point16(240, 170), fontsize);
    dbgWnd->addText("#", Point16(240, 180), fontsize);
    dbgWnd->addText("#", Point16(240, 190), fontsize);
    dbgWnd->addText("#", Point16(240, 200), fontsize);
    dbgWnd->addText("#", Point16(240, 210), fontsize);
    dbgWnd->addText("#", Point16(240, 220), fontsize);
}
...
{
    if(!FrameCounterText)
        FrameCounterText = dbgWnd->addText("", Point16(0, 10), fontsize);
    ...
    if(tmpFrameCtr == 10)
    {
        ...
        if(!FramesPerSecText)
            FramesPerSecText = dbgWnd->addText("", Point16(0, 20), fontsize);
    ...
    if(!RegisteredMenusText)
        RegisteredMenusText = dbgWnd->addText("", Point16(0, 60), fontsize);
    ...
    if(!RegisteredWindowsText)
        RegisteredWindowsText = dbgWnd->addText("", Point16(0, 70), fontsize);
    ...
    if(!RegisteredCallbacksText)
        RegisteredCallbacksText = dbgWnd->addText("", Point16(0, 80), fontsize);
    ...
    if(!DisplayRectText)
        DisplayRectText = dbgWnd->addText("", Point16(0, 90), fontsize);
    ...
    if(MapObj)
    {
        ...
        if(!MapNameText)
            MapNameText = dbgWnd->addText("", Point16(260, 10), fontsize);
        MapNameText->setText("Map Name: " + map->getName());
        if(!MapSizeText)
            MapSizeText = dbgWnd->addText("", Point16(260, 20), fontsize);
        MapSizeText->setText(helpers::format("Width: %d  Height: %d", map->width, map->height));
        if(!MapAuthorText)
            MapAuthorText = dbgWnd->addText("", Point16(260, 30), fontsize);
        MapAuthorText->setText("Author: " + map->getAuthor());
        if(!MapTypeText)
            MapTypeText = dbgWnd->addText("", Point16(260, 40), fontsize);
        const char* ltStr =
        ...
        if(!MapPlayerText)
            MapPlayerText = dbgWnd->addText("", Point16(260, 50), fontsize);
        MapPlayerText->setText(helpers::format("Player: %d", map->player));
        if(!VertexText)
            VertexText = dbgWnd->addText("", Point16(260, 60), fontsize);
        VertexText->setText(helpers::format("Vertex: %d, %d", MapObj->Vertex_.x, MapObj->Vertex_.y));
        if(!VertexDataText)
            VertexDataText = dbgWnd->addText("", Point16(260, 70), fontsize);
        ...
        if(!VertexVectorText)
            VertexVectorText = dbgWnd->addText("", Point16(260, 80), fontsize);
        ...
        if(!animalText)
            animalText = dbgWnd->addText("", Point16(260, 150), fontsize);
        animalText->setText(helpers::format("animal: %#04x", vertex.animal));
        if(!unknown1Text)
            unknown1Text = dbgWnd->addText("", Point16(260, 160), fontsize);
        unknown1Text->setText(helpers::format("unknown1: %#04x", vertex.unknown1));
        if(!buildText)
            buildText = dbgWnd->addText("", Point16(260, 170), fontsize);
        ...
        if(!resourceText)
            resourceText = dbgWnd->addText("", Point16(260, 200), fontsize);
        resourceText->setText(helpers::format("resource: %#04x", vertex.resource));
        if(!shadingText)
            shadingText = dbgWnd->addText("", Point16(260, 210), fontsize);
        shadingText->setText(helpers::format("shading: %#04x", vertex.shading));
        if(!unknown5Text)
            unknown5Text = dbgWnd->addText("", Point16(260, 220), fontsize);
        unknown5Text->setText(helpers::format("unknown5: %#04x", vertex.unknown5));
        if(!editorModeText)
            editorModeText = dbgWnd->addText("", Point16(260, 230), fontsize);
    ...
    {
        if(!MapNameText)
            dbgWnd->addText("", Point16(260, 10), fontsize);
