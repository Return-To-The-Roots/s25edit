...
CButton::CButton(void callback(int), int clickedParam, Uint16 x, Uint16 y, Uint16 w, Uint16 h, int color, const char *text, int button_picture)
{
    marked = false;
    clicked = false;
    this->x = x;
...
bool CButton::render(void)
{
    ...
    if (Surf_Button->w - pos_x > 0)
    {
        ...
        if (Surf_Button->h - pos_y > 0)
            CSurface::Draw(Surf_Button, global::bmpArray[pic_background].surface, pos_x, pos_y, 0, 0, Surf_Button->w - pos_x, Surf_Button->h - pos_y);
    }
    ...
    if (Surf_Button->w-2 - pos_x > 0)
    {
        ...
        if (Surf_Button->h-2 - pos_y > 0)
            CSurface::Draw(Surf_Button, global::bmpArray[foreground].surface, pos_x, pos_y, 0, 0, Surf_Button->w-2 - pos_x, Surf_Button->h-2 - pos_y);
    }
