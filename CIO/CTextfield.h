...
class CTextfield
{
    ...
    public:
        ...
        CTextfield(Uint16 x = 0, Uint16 y = 0, Uint16 cols = 10, Uint16 rows = 1, int fontsize = 14, int text_color = FONT_YELLOW, int bg_color = -1, bool button_style = false);
        ~CTextfield();
        //Access
        ...
        bool render(void);
        SDL_Surface* getSurface(void) { render(); return Surf_Text; }
