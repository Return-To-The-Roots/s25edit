...
class CMenu
{
    ...
    public:
        ...
        CFont* addText(const char *string, int x = 0, int y = 0, int fontsize = 9, int color = FONT_BLUE);
        CFont* addText(unsigned char *string, int x = 0, int y = 0, int fontsize = 9, int color = FONT_BLUE);
